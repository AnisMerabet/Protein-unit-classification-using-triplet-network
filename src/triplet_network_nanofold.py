...
class TripletGRUNetwork(nn.Module):
    ...
    def forward(self, anchor_batch, positive_batch, negative_batch):
        ...
        # Find the maximum sequence length for each sequence nanofold in the batch
...
eval_info_file = '/home/auber/merabet/model_evaluation/eval_nanofold/model_eval_nanofold.txt'
...
# Load topology model
topology_model_path = os.path.join(model_save_dir, 'tripletn_topology_best_model.h5')
triplet_gru_network = TripletGRUNetwork(input_size, hidden_size, num_layers).to(device)
triplet_gru_network.load_state_dict(torch.load(topology_model_path))
...
# Load datasets
train_dataset = TripletDataset('/home/auber/merabet/datasets/train_nanofold.txt', '/home/auber/merabet/PU_nPU_embeddings')

# Load the validation dataset
validation_dataset = TripletDataset('/home/auber/merabet/datasets/validation_nanofold.txt', '/home/auber/merabet/PU_nPU_embeddings')
...
for epoch in range(num_epochs):
    ...
    #model_checkpoint_path = os.path.join(model_save_dir, f'tripletn_nanofold_epoch{epoch + 1}_.h5')
    ...
    if average_validation_loss < best_validation_loss:
        ...
        model_checkpoint_path = os.path.join(model_save_dir, f'tripletn_nanofold_best_model.h5')
        torch.save(triplet_gru_network.state_dict(), model_checkpoint_path)
        counter_no_improvement = 0
    else:
...
if best_epoch_embeddings is not None:
    for j, anchor_name in enumerate(best_epoch_embeddings['anchor_names']):
        ...
        anchor_embedding_path = os.path.join('/home/auber/merabet/model_embeddings/embeddings_nanofold', f'{anchor_name}_{anchor_category}_nanofold.pt')
        torch.save(anchor_embedding, anchor_embedding_path)

# Write the best epoch and best validation loss into model_eval_nanofold.txt
with open(eval_info_file, 'a') as eval_file:
...
eval_info_file = '/home/auber/merabet/model_evaluation/eval_nanofold/model_eval_nanofold.txt' # Path to the model evaluation file
model_save_dir = '/home/auber/merabet/models' # Directory to the saved models
embedding_dir = '/home/auber/merabet/model_embeddings/embeddings_nanofold'  # Directory containing embedding files
...
pt_files_dir = '/home/auber/merabet/model_embeddings/embeddings_nanofold/'
...
#plt.legend()
plt.savefig('/home/auber/merabet/model_evaluation/eval_nanofold/PCA_train_nanofold.png')
print("PCA plot saved to /home/auber/merabet/model_evaluation/eval_nanofold/PCA_train_nanofold.png")
...
#plt.legend()
plt.savefig('/home/auber/merabet/model_evaluation/eval_nanofold/MDS_train_nanofold.png')
print("MDS plot saved to /home/auber/merabet/model_evaluation/eval_nanofold/MDS_train_nanofold.png")
...
#plt.legend()
plt.savefig('/home/auber/merabet/model_evaluation/eval_nanofold/tSNE_train_nanofold.png')
print("t-SNE plot saved to /home/auber/merabet/model_evaluation/eval_nanofold/tSNE_train_nanofold.png")
...
#plt.legend()
plt.savefig('/home/auber/merabet/model_evaluation/eval_nanofold/UMAP_train_nanofold.png')
print("UMAP plot saved to /home/auber/merabet/model_evaluation/eval_nanofold/UMAP_train_nanofold.png")


## Evaluate the model on the test dataset -----------------------------------------------------------------------------------------------------
# Load the best model
best_model_path = os.path.join(model_save_dir, 'tripletn_nanofold_best_model.h5')
...
test_dataset = TripletDataset('/home/auber/merabet/datasets/test_nanofold.txt', '/home/auber/merabet/PU_nPU_embeddings')
...
with torch.no_grad():
    ...
    plt.ylabel('PCA Dimension 2')
    #plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_nanofold/PCA_test_nanofold.png')
    print("PCA plot saved to /home/auber/merabet/model_evaluation/eval_nanofold/PCA_test_nanofold.png")
    ...
    plt.ylabel('MDS Dimension 2')
    #plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_nanofold/MDS_test_nanofold.png')
    print("MDS plot saved to /home/auber/merabet/model_evaluation/eval_nanofold/MDS_test_nanofold.png")
    ...
    plt.ylabel('t-SNE Dimension 2')
    #plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_nanofold/tSNE_test_nanofold.png')
    print("t-SNE plot saved to /home/auber/merabet/model_evaluation/eval_nanofold/tSNE_test_nanofold.png")
    ...
    plt.ylabel('UMAP Dimension 2')
    #plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_nanofold/UMAP_test_nanofold.png')
    print("UMAP plot saved to /home/auber/merabet/model_evaluation/eval_nanofold/UMAP_test_nanofold.png")
   ...
   # Plot the distance distributions
    ...
    plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_nanofold/distances_test_nanofold.png')
    print("Distances Histogram Plot saved to /home/auber/merabet/model_evaluation/eval_nanofold/distances_test_nanofold.png")
    plt.clf()  # or 
    plt.close()
    ...
    plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_nanofold/logistic_regression_nanofold.png')
    print("Logistic Regression Plot saved to /home/auber/merabet/model_evaluation/eval_nanofold/logistic_regression_nanofold.png")
    ...
    # Save ROC curve plot
    roc_curve_save_path = '/home/auber/merabet/model_evaluation/eval_nanofold/roc_curve_nanofold.png'
    ...
    pr_curve_save_path = '/home/auber/merabet/model_evaluation/eval_nanofold/pr_curve_nanofold.png'
    ...
    plt.savefig('/home/auber/merabet/model_evaluation/eval_nanofold/confusion_matrix_nanofold.png')
    print("Confusion Matrix saved to /home/auber/merabet/model_evaluation/eval_nanofold/confusion_matrix_nanofold.png")
    ...
    for case in cases:
        ...
        bar_plot_category_path = f'/home/auber/merabet/model_evaluation/eval_nanofold/barplot_category_nanofold_{case["name"]}.png'
    ...
    output_file_path = '/home/auber/merabet/model_evaluation/eval_nanofold/categories_eval_nanofold.txt'
...
# Append the test loss to the model_eval_nanofold.txt file
with open(eval_info_file, 'a') as eval_file:
...
save_path = '/home/auber/merabet/model_evaluation/eval_nanofold/Loss_plot_nanofold.png'
