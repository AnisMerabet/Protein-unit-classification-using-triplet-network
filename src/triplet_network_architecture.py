...
class TripletGRUNetwork(nn.Module):
    ...
    def forward(self, anchor_batch, positive_batch, negative_batch):
        ...
        # Find the maximum sequence length for each sequence architecture in the batch
...
eval_info_file = '/home/auber/merabet/model_evaluation/eval_architecture/model_eval_architecture.txt'
...
# Load class model
class_model_path = os.path.join(model_save_dir, 'tripletn_class_best_model.h5')
triplet_gru_network = TripletGRUNetwork(input_size, hidden_size, num_layers).to(device)
triplet_gru_network.load_state_dict(torch.load(class_model_path))
...
# Load datasets
train_dataset = TripletDataset('/home/auber/merabet/datasets/train_architecture.txt', '/home/auber/merabet/PU_nPU_embeddings')

# Load the validation dataset
validation_dataset = TripletDataset('/home/auber/merabet/datasets/validation_architecture.txt', '/home/auber/merabet/PU_nPU_embeddings')
...
for epoch in range(num_epochs):
    ...
    #model_checkpoint_path = os.path.join(model_save_dir, f'tripletn_architecture_epoch{epoch + 1}_.h5')
    ...
    if average_validation_loss < best_validation_loss:
        ...
        model_checkpoint_path = os.path.join(model_save_dir, f'tripletn_architecture_best_model.h5')
        torch.save(triplet_gru_network.state_dict(), model_checkpoint_path)
        counter_no_improvement = 0
    else:
...
if best_epoch_embeddings is not None:
    for j, anchor_name in enumerate(best_epoch_embeddings['anchor_names']):
        ...
        anchor_embedding_path = os.path.join('/home/auber/merabet/model_embeddings/embeddings_architecture', f'{anchor_name}_{anchor_category}_architecture.pt')
        torch.save(anchor_embedding, anchor_embedding_path)

# Write the best epoch and best validation loss into model_eval_architecture.txt
with open(eval_info_file, 'a') as eval_file:
...
eval_info_file = '/home/auber/merabet/model_evaluation/eval_architecture/model_eval_architecture.txt' # Path to the model evaluation file
model_save_dir = '/home/auber/merabet/models' # Directory to the saved models
embedding_dir = '/home/auber/merabet/model_embeddings/embeddings_architecture'  # Directory containing embedding files
...
pt_files_dir = '/home/auber/merabet/model_embeddings/embeddings_architecture/'
...
#plt.legend()
plt.savefig('/home/auber/merabet/model_evaluation/eval_architecture/PCA_train_architecture.png')
print("PCA plot saved to /home/auber/merabet/model_evaluation/eval_architecture/PCA_train_architecture.png")
...
#plt.legend()
plt.savefig('/home/auber/merabet/model_evaluation/eval_architecture/MDS_train_architecture.png')
print("MDS plot saved to /home/auber/merabet/model_evaluation/eval_architecture/MDS_train_architecture.png")
...
#plt.legend()
plt.savefig('/home/auber/merabet/model_evaluation/eval_architecture/tSNE_train_architecture.png')
print("t-SNE plot saved to /home/auber/merabet/model_evaluation/eval_architecture/tSNE_train_architecture.png")
...
#plt.legend()
plt.savefig('/home/auber/merabet/model_evaluation/eval_architecture/UMAP_train_architecture.png')
print("UMAP plot saved to /home/auber/merabet/model_evaluation/eval_architecture/UMAP_train_architecture.png")


## Evaluate the model on the test dataset -----------------------------------------------------------------------------------------------------
# Load the best model
best_model_path = os.path.join(model_save_dir, 'tripletn_architecture_best_model.h5')
...
test_dataset = TripletDataset('/home/auber/merabet/datasets/test_architecture.txt', '/home/auber/merabet/PU_nPU_embeddings')
...
with torch.no_grad():
    ...
    plt.ylabel('PCA Dimension 2')
    #plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_architecture/PCA_test_architecture.png')
    print("PCA plot saved to /home/auber/merabet/model_evaluation/eval_architecture/PCA_test_architecture.png")
    ...
    plt.ylabel('MDS Dimension 2')
    #plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_architecture/MDS_test_architecture.png')
    print("MDS plot saved to /home/auber/merabet/model_evaluation/eval_architecture/MDS_test_architecture.png")
    ...
    plt.ylabel('t-SNE Dimension 2')
    #plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_architecture/tSNE_test_architecture.png')
    print("t-SNE plot saved to /home/auber/merabet/model_evaluation/eval_architecture/tSNE_test_architecture.png")
    ...
    plt.ylabel('UMAP Dimension 2')
    #plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_architecture/UMAP_test_architecture.png')
    print("UMAP plot saved to /home/auber/merabet/model_evaluation/eval_architecture/UMAP_test_architecture.png")
   ...
   # Plot the distance distributions
    ...
    plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_architecture/distances_test_architecture.png')
    print("Distances Histogram Plot saved to /home/auber/merabet/model_evaluation/eval_architecture/distances_test_architecture.png")
    plt.clf()  # or 
    plt.close()
    ...
    plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_architecture/logistic_regression_architecture.png')
    print("Logistic Regression Plot saved to /home/auber/merabet/model_evaluation/eval_architecture/logistic_regression_architecture.png")
    ...
    # Save ROC curve plot
    roc_curve_save_path = '/home/auber/merabet/model_evaluation/eval_architecture/roc_curve_architecture.png'
    ...
    pr_curve_save_path = '/home/auber/merabet/model_evaluation/eval_architecture/pr_curve_architecture.png'
    ...
    plt.savefig('/home/auber/merabet/model_evaluation/eval_architecture/confusion_matrix_architecture.png')
    print("Confusion Matrix saved to /home/auber/merabet/model_evaluation/eval_architecture/confusion_matrix_architecture.png")
    ...
    for case in cases:
        ...
        bar_plot_category_path = f'/home/auber/merabet/model_evaluation/eval_architecture/barplot_category_architecture_{case["name"]}.png'
    ...
    output_file_path = '/home/auber/merabet/model_evaluation/eval_architecture/categories_eval_architecture.txt'
...
# Append the test loss to the model_eval_architecture.txt file
with open(eval_info_file, 'a') as eval_file:
...
save_path = '/home/auber/merabet/model_evaluation/eval_architecture/Loss_plot_architecture.png'
