...
class TripletGRUNetwork(nn.Module):
    ...
    def forward(self, anchor_batch, positive_batch, negative_batch):
        ...
        # Find the maximum sequence length for each sequence one_hot_architecture in the batch
...
class TripletDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Update the path to read .fasta files
        anchor_fasta_path = os.path.join(
            "/home/auber/merabet/PU_nPU_fasta_files",  # Updated path
            f"{anchor}.fasta"
        )
        positive_fasta_path = os.path.join(
            "/home/auber/merabet/PU_nPU_fasta_files",  # Updated path
            f"{positive}.fasta"
        )
        negative_fasta_path = os.path.join(
            "/home/auber/merabet/PU_nPU_fasta_files",  # Updated path
            f"{negative}.fasta"
        )

        # Read .fasta files and perform one-hot encoding
        anchor_sequence = str(SeqIO.read(anchor_fasta_path, "fasta").seq)
        positive_sequence = str(SeqIO.read(positive_fasta_path, "fasta").seq)
        negative_sequence = str(SeqIO.read(negative_fasta_path, "fasta").seq)

        # Perform one-hot encoding
        anchor_embedding = self.one_hot_encoding(anchor_sequence)
        positive_embedding = self.one_hot_encoding(positive_sequence)
        negative_embedding = self.one_hot_encoding(negative_sequence)
    ...
    def one_hot_encoding(self, sequence):
        # Define a mapping for one-hot encoding of amino acids
        amino_acids = 'ACDEFGHIKLMNPQRSTVWY'
        mapping = {acid: i for i, acid in enumerate(amino_acids)}

        # Perform one-hot encoding
        one_hot_sequence = torch.zeros(len(sequence), len(mapping))
        for i, aa in enumerate(sequence):
            if aa in mapping:
                one_hot_sequence[i, mapping[aa]] = 1
...
eval_info_file = '/home/auber/merabet/model_evaluation/eval_one_hot_architecture/model_eval_one_hot_architecture.txt'

# Define parameters
input_size = 20  # Embedding dimension
...
# Load one_hot_class model
one_hot_class_model_path = os.path.join(model_save_dir, 'tripletn_one_hot_class_best_model.h5')
triplet_gru_network = TripletGRUNetwork(input_size, hidden_size, num_layers).to(device)
triplet_gru_network.load_state_dict(torch.load(one_hot_class_model_path))
...
# Load datasets
train_dataset = TripletDataset('/home/auber/merabet/datasets/train_architecture.txt')

# Load the validation dataset
validation_dataset = TripletDataset('/home/auber/merabet/datasets/validation_architecture.txt')
...
for epoch in range(num_epochs):
    ...
    #model_checkpoint_path = os.path.join(model_save_dir, f'tripletn_one_hot_architecture_epoch{epoch + 1}_.h5')
    ...
    if average_validation_loss < best_validation_loss:
        ...
        model_checkpoint_path = os.path.join(model_save_dir, f'tripletn_one_hot_architecture_best_model.h5')
        torch.save(triplet_gru_network.state_dict(), model_checkpoint_path)
        counter_no_improvement = 0
    else:
...
if best_epoch_embeddings is not None:
    for j, anchor_name in enumerate(best_epoch_embeddings['anchor_names']):
        ...
        anchor_embedding_path = os.path.join('/home/auber/merabet/model_embeddings/embeddings_one_hot_architecture', f'{anchor_name}_{anchor_category}_one_hot_architecture.pt')
        torch.save(anchor_embedding, anchor_embedding_path)

# Write the best epoch and best validation loss into model_eval_one_hot_architecture.txt
with open(eval_info_file, 'a') as eval_file:
...
eval_info_file = '/home/auber/merabet/model_evaluation/eval_one_hot_architecture/model_eval_one_hot_architecture.txt' # Path to the model evaluation file
model_save_dir = '/home/auber/merabet/models' # Directory to the saved models
embedding_dir = '/home/auber/merabet/model_embeddings/embeddings_one_hot_architecture'  # Directory containing embedding files
...
pt_files_dir = '/home/auber/merabet/model_embeddings/embeddings_one_hot_architecture/'
...
for selected_pt_file in selected_pt_files:
    ...
    anchor_category = "_".join(selected_pt_file.split('_')[4:-3])
...
#plt.legend()
plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_architecture/PCA_train_one_hot_architecture.png')
print("PCA plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_architecture/PCA_train_one_hot_architecture.png")
...
#plt.legend()
plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_architecture/MDS_train_one_hot_architecture.png')
print("MDS plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_architecture/MDS_train_one_hot_architecture.png")
...
#plt.legend()
plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_architecture/tSNE_train_one_hot_architecture.png')
print("t-SNE plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_architecture/tSNE_train_one_hot_architecture.png")
...
#plt.legend()
plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_architecture/UMAP_train_one_hot_architecture.png')
print("UMAP plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_architecture/UMAP_train_one_hot_architecture.png")


## Evaluate the model on the test dataset -----------------------------------------------------------------------------------------------------
# Load the best model
best_model_path = os.path.join(model_save_dir, 'tripletn_one_hot_architecture_best_model.h5')
...
test_dataset = TripletDataset('/home/auber/merabet/datasets/test_architecture.txt')
...
with torch.no_grad():
    ...
    for i in range(0, num_test_triplets, batch_size):
        ...
        for j, anchor_embedding_test_normalized in enumerate(gru1_hidden_test_normalized):
            ...
            closest_file_category_first_closest = "_".join(min_distance_file_first_closest.split('_')[4:-3])

            # Extract categories from the closest file names for the 5 closest categories
            closest_file_categories_5_closest = ["_".join(file.split('_')[4:-3]) for file in min_distance_files_5_closest]
    ...
    plt.ylabel('PCA Dimension 2')
    #plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_architecture/PCA_test_one_hot_architecture.png')
    print("PCA plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_architecture/PCA_test_one_hot_architecture.png")
    ...
    plt.ylabel('MDS Dimension 2')
    #plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_architecture/MDS_test_one_hot_architecture.png')
    print("MDS plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_architecture/MDS_test_one_hot_architecture.png")
    ...
    plt.ylabel('t-SNE Dimension 2')
    #plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_architecture/tSNE_test_one_hot_architecture.png')
    print("t-SNE plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_architecture/tSNE_test_one_hot_architecture.png")
    ...
    plt.ylabel('UMAP Dimension 2')
    #plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_architecture/UMAP_test_one_hot_architecture.png')
    print("UMAP plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_architecture/UMAP_test_one_hot_architecture.png")
   ...
   # Plot the distance distributions
    ...
    plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_architecture/distances_test_one_hot_architecture.png')
    print("Distances Histogram Plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_architecture/distances_test_one_hot_architecture.png")
    plt.clf()  # or 
    plt.close()
    ...
    plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_architecture/logistic_regression_one_hot_architecture.png')
    print("Logistic Regression Plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_architecture/logistic_regression_one_hot_architecture.png")
    ...
    # Save ROC curve plot
    roc_curve_save_path = '/home/auber/merabet/model_evaluation/eval_one_hot_architecture/roc_curve_one_hot_architecture.png'
    ...
    pr_curve_save_path = '/home/auber/merabet/model_evaluation/eval_one_hot_architecture/pr_curve_one_hot_architecture.png'
    ...
    plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_architecture/confusion_matrix_one_hot_architecture.png')
    print("Confusion Matrix saved to /home/auber/merabet/model_evaluation/eval_one_hot_architecture/confusion_matrix_one_hot_architecture.png")
    ...
    for case in cases:
        ...
        bar_plot_category_path = f'/home/auber/merabet/model_evaluation/eval_one_hot_architecture/barplot_category_one_hot_architecture_{case["name"]}.png'
    ...
    output_file_path = '/home/auber/merabet/model_evaluation/eval_one_hot_architecture/categories_eval_one_hot_architecture.txt'
...
# Append the test loss to the model_eval_one_hot_architecture.txt file
with open(eval_info_file, 'a') as eval_file:
...
save_path = '/home/auber/merabet/model_evaluation/eval_one_hot_architecture/Loss_plot_one_hot_architecture.png'
