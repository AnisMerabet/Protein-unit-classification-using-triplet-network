...
class TripletGRUNetwork(nn.Module):
    ...
    def forward(self, anchor_batch, positive_batch, negative_batch):
        ...
        # Find the maximum sequence length for each sequence one_hot_type in the batch
...
eval_info_file = '/home/auber/merabet/model_evaluation/eval_one_hot_type/model_eval_one_hot_type.txt'
...
# Load datasets
train_dataset = TripletDataset('/home/auber/merabet/datasets/train_type.txt')

# Load the validation dataset
validation_dataset = TripletDataset('/home/auber/merabet/datasets/validation_type.txt')
...
for epoch in range(num_epochs):
    ...
    #model_checkpoint_path = os.path.join(model_save_dir, f'tripletn_one_hot_type_epoch{epoch + 1}_.h5')
    ...
    if average_validation_loss < best_validation_loss:
        ...
        model_checkpoint_path = os.path.join(model_save_dir, f'tripletn_one_hot_type_best_model.h5')
        torch.save(triplet_gru_network.state_dict(), model_checkpoint_path)
        counter_no_improvement = 0
    else:
...
if best_epoch_embeddings is not None:
    for j, anchor_name in enumerate(best_epoch_embeddings['anchor_names']):
        ...
        anchor_embedding_path = os.path.join('/home/auber/merabet/model_embeddings/embeddings_one_hot_type', f'{anchor_name}_{anchor_category}_one_hot_type.pt')
        torch.save(anchor_embedding, anchor_embedding_path)

# Write the best epoch and best validation loss into model_eval_one_hot_type.txt
with open(eval_info_file, 'a') as eval_file:
...
eval_info_file = '/home/auber/merabet/model_evaluation/eval_one_hot_type/model_eval_one_hot_type.txt' # Path to the model evaluation file
model_save_dir = '/home/auber/merabet/models' # Directory to the saved models
embedding_dir = '/home/auber/merabet/model_embeddings/embeddings_one_hot_type'  # Directory containing embedding files
...
pt_files_dir = '/home/auber/merabet/model_embeddings/embeddings_one_hot_type/'
...
plt.legend()
plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_type/PCA_train_one_hot_type.png')
print("PCA plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_type/PCA_train_one_hot_type.png")
...
plt.legend()
plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_type/MDS_train_one_hot_type.png')
print("MDS plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_type/MDS_train_one_hot_type.png")
...
plt.legend()
plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_type/tSNE_train_one_hot_type.png')
print("t-SNE plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_type/tSNE_train_one_hot_type.png")
...
plt.legend()
plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_type/UMAP_train_one_hot_type.png')
print("UMAP plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_type/UMAP_train_one_hot_type.png")


## Evaluate the model on the test dataset -----------------------------------------------------------------------------------------------------
# Load the best model
best_model_path = os.path.join(model_save_dir, 'tripletn_one_hot_type_best_model.h5')
...
test_dataset = TripletDataset('/home/auber/merabet/datasets/test_type.txt')
...
with torch.no_grad():
    ...
    plt.ylabel('PCA Dimension 2')
    plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_type/PCA_test_one_hot_type.png')
    print("PCA plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_type/PCA_test_one_hot_type.png")
    ...
    plt.ylabel('MDS Dimension 2')
    plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_type/MDS_test_one_hot_type.png')
    print("MDS plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_type/MDS_test_one_hot_type.png")
    ...
    plt.ylabel('t-SNE Dimension 2')
    plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_type/tSNE_test_one_hot_type.png')
    print("t-SNE plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_type/tSNE_test_one_hot_type.png")
    ...
    plt.ylabel('UMAP Dimension 2')
    plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_type/UMAP_test_one_hot_type.png')
    print("UMAP plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_type/UMAP_test_one_hot_type.png")
   ...
   # Plot the distance distributions
    ...
    plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_type/distances_test_one_hot_type.png')
    print("Distances Histogram Plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_type/distances_test_one_hot_type.png")
    plt.clf()  # or 
    plt.close()
    ...
    plt.legend()
    plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_type/logistic_regression_one_hot_type.png')
    print("Logistic Regression Plot saved to /home/auber/merabet/model_evaluation/eval_one_hot_type/logistic_regression_one_hot_type.png")
    ...
    # Save ROC curve plot
    roc_curve_save_path = '/home/auber/merabet/model_evaluation/eval_one_hot_type/roc_curve_one_hot_type.png'
    ...
    pr_curve_save_path = '/home/auber/merabet/model_evaluation/eval_one_hot_type/pr_curve_one_hot_type.png'
    ...
    plt.savefig('/home/auber/merabet/model_evaluation/eval_one_hot_type/confusion_matrix_one_hot_type.png')
    print("Confusion Matrix saved to /home/auber/merabet/model_evaluation/eval_one_hot_type/confusion_matrix_one_hot_type.png")
    ...
    for case in cases:
        ...
        bar_plot_category_path = f'/home/auber/merabet/model_evaluation/eval_one_hot_type/barplot_category_one_hot_type_{case["name"]}.png'
    ...
    output_file_path = '/home/auber/merabet/model_evaluation/eval_one_hot_type/categories_eval_one_hot_type.txt'
...
# Append the test loss to the model_eval_one_hot_type.txt file
with open(eval_info_file, 'a') as eval_file:
...
save_path = '/home/auber/merabet/model_evaluation/eval_one_hot_type/Loss_plot_one_hot_type.png'
